...
/**
 * Define acelin settings file
 */
function acelin_customizer_register( $wp_customize ) {
...
add_action( 'customize_register', 'acelin_customizer_register' );


/**
 * acelin Customizer custom control classes
 */
